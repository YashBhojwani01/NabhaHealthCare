...
// Preferred hero image path - save your image to public/images/home-hero.jpg
const PREFERRED_HERO = "/images/home-hero.jpg";
const FALLBACK_LOCAL_HERO = "/images/landing-hero.svg";
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="flex justify-center">
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 w-full sm:w-auto">
                    <Link to="/signup/patient">
                      <Button variant="secondary" size="lg" className="shadow-button w-full">
                        Patient Sign Up
                      </Button>
                    </Link>
            ...
            <div className="relative">
              <img 
                ...
                onError={(e) => { (e.currentTarget as HTMLImageElement).src = FALLBACK_LOCAL_HERO; }}
              />
            </div>
          </div>
        </div>
